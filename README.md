...
```
~# wget https://raw.githubusercontent.com/Weilbyte/nwpmx/master/nwpmx.sh
~# bash nwpmx.sh install
```
Or this oneliner
```
bash <(curl -s https://raw.githubusercontent.com/Weilbyte/nwpmx/master/nwpmx.sh ) install
```
...
<a href="https://github.com/weilbyte/nwpmx/graphs/contributors">
